...
async function sentPost(date_marcacao_reservation, user_identifier_reservation, spot_identifier_reservation, date_marcada_reservation, payment_credit_card_number, payment_cvc_number){

  console.log("sentposttttttttttttttttttt");

  console.log(date_marcacao_reservation);
  console.log(user_identifier_reservation);
  console.log(spot_identifier_reservation);
  console.log(date_marcada_reservation);
  console.log(payment_credit_card_number);
  console.log(payment_cvc_number);

  var id_spot = spot_identifier_reservation;
  ...
  try {
    ...
    console.log("CHEGOU");
     ...
     let data = {
      ...
      spot_identifier_reservation: spot_identifier_reservation,
     ...
     let newExercise2 = await $.ajax({
      url: "/users/setspotunavailable/" + id_spot,
      method: "put",
      data: JSON.stringify(data),
      contentType: "application/json",
      dataType: "json"
...
async function showValuee(table){
 ...
 //  let payment_credit_card_number = bcrypt.hashSync(fullpaymentcreditcardnumber, salt);
   ...
   var spot_identifier_reservation = table.spot_id;
   ...
   var payment_cvc_number = document.getElementById("cvcnumber").value;
    ...
    sentPost(date_marcacao_reservation, user_identifier_reservation, spot_identifier_reservation, date_marcada_reservation, payment_credit_card_number, payment_cvc_number);
...
function createtableHTML(table){
  ...
  return "<button id='buttonoption' onclick='showValuee(" + JSON.stringify(table) + ")' style='background-color: transparent; border: 0; width: 100%;'><a href='#'>" + table.spot_number + "</a></button>"
...
async function getAvailableTables(rest_id){
  ...
  url: "/users/getlugares/estacionamento/" + rest_id,
  method: "get",
  dataType: "json",
